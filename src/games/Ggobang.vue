	...
	export default {
		...
		methods: {
			...
			drawChess(x, y) {
				...
				grd.addColorStop(0, _this.whiteTurn ? "#ffffff" : "#282828");
				grd.addColorStop(1, _this.whiteTurn ? "#c8c8c8" : "#000000");
				_this.ctx.beginPath();
			...
			drawText() {
				...
				_this.ctx.fillStyle = "#f16c4d";
				_this.ctx.font = "22px 微软雅黑";
...
<style scoped>
	#Ggobang {
		...
		/* background-image: url('../assets/backgrounds/星空.jpg'); */
